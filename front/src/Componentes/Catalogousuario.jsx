...
function PantallaVehiculos() {
    ...
    // Función para manejar el clic en el botón "Chat"
    const handleChatClick = () => {
        navigate("/Componentes/ChatCliente"); // Redirige a la pantalla de chat cliente
    };
                    ...
                    <div className="bg-gray-800 p-6 rounded-lg shadow-lg w-full">
                        <div className="text-center mb-6">
                            <img
                                ...
                                alt="Foto de usuario"
                                className="w-20 h-20 rounded-full border-4 border-white ml-4"
                            />
                            <h3 className="mt-3 text-lg font-bold text-white">Nombre del Usuario</h3>
                            <div className="text-yellow-400 text-xl">★★★★★</div>
                        </div>
                        <div className="text-center mb-4">
                            <button
                                className="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded-lg shadow-lg"
                                onClick={handleChatClick} // Redirige a la pantalla de chat cliente
                            >
                                Chat
                            </button>
                        </div>
